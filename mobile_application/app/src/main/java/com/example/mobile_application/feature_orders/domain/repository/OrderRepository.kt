...
interface OrderRepository {
   ...
   // suspend fun getAllOrders(): Flow<Resource<List<Order>>>
    ...
    // Create a new order
    suspend fun createOrder(orderRequest: CreateOrderRequest): Flow<Resource<Unit>>
    ...
    suspend fun addOrderReview(orderId: String, rating: Float, review: String): Flow<Resource<Unit>>
